...
FlashInfer 面向 serving 的 ragged/paged KV、decode、MLA、grouped GEMM/MoE 等更广 workload；FlashAttention 是其中 attention IO 优化思想的代表，但两者不是简单替代关系。
...
- 官方/上游实现参考：<https://docs.flashinfer.ai/>
