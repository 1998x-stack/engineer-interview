...
MoE 降低 active FLOPs，却增加 routing、A2A、小/不规则 expert GEMM 和 straggler。实际 latency 由最慢 expert/通信关键路径决定，而不是总 FLOPs。
...
构造低/高并发，记录 tokens/expert histogram、grouped GEMM shape、A2A time；确认 latency 改善来自更大 expert batch。
