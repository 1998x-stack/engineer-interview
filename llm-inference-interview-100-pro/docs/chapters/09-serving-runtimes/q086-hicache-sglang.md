...
HiCache 把 RadixAttention 的 GPU cache 扩成 L1 GPU、L2 host、L3 distributed storage；关键问题变成 prefetch、write policy、layout、I/O backend 与 tier-aware routing。
...
- 官方/上游实现参考：<https://github.com/sgl-project/sglang/blob/main/docs_new/docs/advanced_features/hicache_best_practices.mdx>
...
构造重复 system prompt 和 multi-turn workload，分别关闭 HiCache、仅 L1、L1+L2/L3，记录 tier hit、IO wait 和 TTFT。
